...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 245px; top: 9px; position: absolute; height: 26px" Text="Find" />
        </div>
        <asp:TextBox ID="txtServiceName" runat="server" style="z-index: 1; left: 69px; top: 14px; position: absolute"></asp:TextBox>
        <asp:Label ID="lblStaff" runat="server" style="z-index: 1; left: 13px; top: 54px; position: absolute; height: 16px; width: 45px;" Text="Staff"></asp:Label>
        ...
        <asp:CheckBox ID="chkDiscount" runat="server" style="z-index: 1; left: 16px; top: 160px; position: absolute" Text="Discount" />
